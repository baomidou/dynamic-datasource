...
public class DruidConfiguration {
    ...
    public Properties toProperties(DruidConfiguration config) {
        Properties properties = new Properties();
        Integer tempInitialSize = initialSize == null ? config.getInitialSize() : initialSize;
        ...
        Integer tempMaxActive = maxActive == null ? config.getMaxActive() : maxActive;
        ...
        Integer tempMinIdle = minIdle == null ? config.getMinIdle() : minIdle;
        if (tempMinIdle != null && !tempMinIdle.equals(DEFAULT_MIN_IDLE)) {
            properties.setProperty("druid.minIdle", String.valueOf(tempMinIdle));
        }

        Long tempMaxWait = maxWait == null ? config.getMaxWait() : maxWait;
        if (tempMaxWait != null && !tempMaxWait.equals(DEFAULT_MAX_WAIT)) {
            properties.setProperty("druid.maxWait", String.valueOf(tempMaxWait));
        }

        Long tempTimeBetweenEvictionRunsMillis = timeBetweenEvictionRunsMillis == null ? config.getTimeBetweenEvictionRunsMillis() : timeBetweenEvictionRunsMillis;
        ...
        Long tempTimeBetweenLogStatsMillis = timeBetweenLogStatsMillis == null ? config.getTimeBetweenLogStatsMillis() : timeBetweenLogStatsMillis;
        ...
        Integer tempStatSqlMaxSize = statSqlMaxSize == null ? config.getStatSqlMaxSize() : statSqlMaxSize;
        if (tempStatSqlMaxSize != null) {
            properties.setProperty("druid.stat.sql.MaxSize", String.valueOf(tempStatSqlMaxSize));
        }

        Long tempMinEvictableIdleTimeMillis = minEvictableIdleTimeMillis == null ? config.getMinEvictableIdleTimeMillis() : minEvictableIdleTimeMillis;
        ...
        Long tempMaxEvictableIdleTimeMillis = maxEvictableIdleTimeMillis == null ? config.getMaxEvictableIdleTimeMillis() : maxEvictableIdleTimeMillis;
        ...
        Boolean tempTestWhileIdle = testWhileIdle == null ? config.getTestWhileIdle() : testWhileIdle;
        if (tempTestWhileIdle != null && !tempTestWhileIdle.equals(DEFAULT_WHILE_IDLE)) {
            properties.setProperty("druid.testWhileIdle", "false");
        }

        Boolean tempTestOnBorrow = testOnBorrow == null ? config.getTestOnBorrow() : testOnBorrow;
        if (tempTestOnBorrow != null && !tempTestOnBorrow.equals(DEFAULT_TEST_ON_BORROW)) {
            properties.setProperty("druid.testOnBorrow", "true");
        }

        String tempValidationQuery = validationQuery == null ? config.getValidationQuery() : validationQuery;
        if (tempValidationQuery != null && tempValidationQuery.length() > 0) {
            properties.setProperty("druid.validationQuery", tempValidationQuery);
        }

        Boolean tempUseGlobalDataSourceStat = useGlobalDataSourceStat == null ? config.getUseGlobalDataSourceStat() : useGlobalDataSourceStat;
        ...
        Boolean tempAsyncInit = asyncInit == null ? config.getAsyncInit() : asyncInit;
        ...
        String tempFilters = filters == null ? config.getFilters() : filters;
        if (tempFilters == null) {
        ...
        Boolean tempClearFiltersEnable = clearFiltersEnable == null ? config.getClearFiltersEnable() : clearFiltersEnable;
        ...
        Boolean tempResetStatEnable = resetStatEnable == null ? config.getResetStatEnable() : resetStatEnable;
        if (tempResetStatEnable != null && tempResetStatEnable.equals(Boolean.FALSE)) {
            properties.setProperty("druid.resetStatEnable", "false");
        }

        Integer tempNotFullTimeoutRetryCount = notFullTimeoutRetryCount == null ? config.getNotFullTimeoutRetryCount() : notFullTimeoutRetryCount;
        ...
        Long tempMaxWaitThreadCount = maxWaitThreadCount == null ? config.getMaxWaitThreadCount() : maxWaitThreadCount;
        ...
        Boolean tempFailFast = failFast == null ? config.getFailFast() : failFast;
        if (tempFailFast != null && tempFailFast.equals(Boolean.TRUE)) {
            properties.setProperty("druid.failFast", "true");
        }

        Integer tempPhyTimeoutMillis = phyTimeoutMillis == null ? config.getPhyTimeoutMillis() : phyTimeoutMillis;
        ...
        Boolean tempKeepAlive = keepAlive == null ? config.getKeepAlive() : keepAlive;
        if (tempKeepAlive != null && tempKeepAlive.equals(Boolean.TRUE)) {
            properties.setProperty("druid.keepAlive", "true");
        }

        Boolean tempPoolPreparedStatements = poolPreparedStatements == null ? config.getPoolPreparedStatements() : poolPreparedStatements;
        ...
        Boolean tempInitVariants = initVariants == null ? config.getInitVariants() : initVariants;
        if (tempInitVariants != null && tempInitVariants.equals(Boolean.TRUE)) {
            properties.setProperty("druid.initVariants", "true");
        }

        Boolean tempInitGlobalVariants = initGlobalVariants == null ? config.getInitGlobalVariants() : initGlobalVariants;
        ...
        Boolean tempUseUnfairLock = useUnfairLock == null ? config.getUseUnfairLock() : useUnfairLock;
        if (tempUseUnfairLock != null) {
            properties.setProperty("druid.useUnfairLock", String.valueOf(tempUseUnfairLock));
        }

        Boolean tempKillWhenSocketReadTimeout = killWhenSocketReadTimeout == null ? config.getKillWhenSocketReadTimeout() : killWhenSocketReadTimeout;
        ...
        Properties tempConnectProperties = connectionProperties == null ? config.getConnectionProperties() : connectionProperties;
        ...
        Integer tempMaxPoolPreparedStatementPerConnectionSize = maxPoolPreparedStatementPerConnectionSize == null ? config.getMaxPoolPreparedStatementPerConnectionSize() : maxPoolPreparedStatementPerConnectionSize;
        ...
        String tempInitConnectionSqls = initConnectionSqls == null ? config.getInitConnectionSqls() : initConnectionSqls;
